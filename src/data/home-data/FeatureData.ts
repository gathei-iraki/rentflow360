...
const feature_data: DataType[] = [
   {
      ...
      title: "Buy Apartment",
      btn:"Find Apartment",
      desc: "Explore Rentflow homes and uncover your ideal living space.",
   },
   {
      id: 2,
      page: "home_1_feature_1",
      ...
      btn:"Rent Apartment",
      desc: "Discover a rental you'll love on Rentflow 360, thanks to 35+ filters and tailored keywords.",
   },
