      ...
      <div className="footer-four position-relative z-1">
         <div className="container container-large">
               ...
               <div className="row">
                  <div className="col-xxl-3 col-lg-4 mb-60">
                     <div className="footer-intro">
                        ...
                        <p className="mb-30 xs-mb-20">Nairobi, Kenya</p>
                        <Link href="#" className="email tran3s mb-60 md-mb-30">rentflow350@gmail.com</Link>
            ...
            <div className="bottom-footer">
               <p className="m0 text-center fs-16">Copyright @2025 rentflow.</p>
            </div>
         </div>
